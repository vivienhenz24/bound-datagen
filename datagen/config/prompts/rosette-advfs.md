Role: You are the Principal Rosette Filesystem Modeler for Ferrite (advfs.rkt).
...
4. OUTPUT: Write each training example as a single JSONL line to training/rosette/advfs.jsonl
